...
//rempli le tableau de structure joueur
...
//affiche les informations du joueur pendant son tour de jeu
...
//détermine le passage, et met en ordre le tableau de structure joueur
